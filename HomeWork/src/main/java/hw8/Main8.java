...
public class Main8 {
    ...
    public static void main(String[] args) {
        HashTableChain<Integer, Integer> hashTableChain = new HashTableChain<>(10);
        hashTableChain.add(1, 100);
        hashTableChain.add(2, 250);
        System.out.println(hashTableChain.print());
        hashTableChain.delete(1);
        System.out.println(hashTableChain.print());
